  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setCountersignLink(
          `http://localhost:3000/CounterSignature/${data.hash}`
        );
      } else {
  ...
  return (
    <div className="container text-center">
      ...
      <form onSubmit={handleSubmit}>
        ...
        {/* Display hash and countersign link if available */}
        {textHash && (
          <div className="alert alert-info">
            <strong>
              Agreement hash generated. To view this agreement in your
              dashboard, please refresh the page.
            </strong>
            <br />
            <code>{textHash}</code>
            {formData.needs_signature === 1 && countersignLink && (
              <>
                <br />
                Share this link with the counterparty to countersign:
                <br />
                <a
